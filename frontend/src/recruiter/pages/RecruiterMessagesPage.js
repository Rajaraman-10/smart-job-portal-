        ...
        {selectedConversation ? (
          <div className="flex h-full flex-col gap-4">
            <div className="flex items-center justify-between border-b border-[#14181C]/10 dark:border-white/10 pb-4">
              <div>
                <h2 className="font-display text-base font-semibold text-[#14181C] dark:text-slate-50">{selectedConversation.applicant_name || 'Candidate'}</h2>
                <p className="text-sm text-[#5B6660] dark:text-slate-400">{selectedConversation.job_title}</p>
              </div>
            </div>
