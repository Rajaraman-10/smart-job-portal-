  ...
  return (
    <div className="space-y-6 font-sans text-[#14181C] dark:text-slate-50">
      <div className="border border-[#14181C]/10 dark:border-white/10 bg-white dark:bg-slate-900 p-6">
        ...
        <h1 className="mt-2 font-display text-xl font-semibold text-[#14181C] dark:text-slate-50">Interview calendar</h1>
      ...
      <div className="border border-[#14181C]/10 dark:border-white/10 bg-white dark:bg-slate-900">
        <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr_1fr] gap-4 border-b border-[#14181C]/10 dark:border-white/10 px-6 py-4 font-data text-xs tracking-widest text-[#5B6660] dark:text-slate-400">
          <div>CANDIDATE</div>
          <div>JOB</div>
          <div>DATE</div>
          <div>TYPE</div>
        ...
        {interviews.map((interview) => (
          <div key={interview.id} className="grid grid-cols-[1.5fr_1fr_1fr_1fr_1fr] gap-4 border-b border-[#14181C]/8 dark:border-white/10 px-6 py-5 text-sm text-[#14181C] dark:text-slate-50">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button type="button" onClick={() => onReschedule(interview)} className="border border-[#14181C]/15 dark:border-white/15 bg-white dark:bg-slate-900 px-3 py-1.5 text-xs font-medium text-[#14181C] dark:text-slate-50 hover:border-[#14181C]/30">
                Reschedule
              </button>
